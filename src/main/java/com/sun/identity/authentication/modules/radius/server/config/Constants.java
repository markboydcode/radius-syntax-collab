...
public class Constants {
    ...
    /**
     * The unique name of the RADIUS service registered in the admin console with our amRadiusServer.xml file
     * exposing configuration pieces in openAM's admin console.
     */
    ...
    /**
     * Name of the global radius service attribute whose value indicates the core pool size for the executor thread
     * pool that processes incoming RADIUS requests. See the service descriptor amRadiusServer.xml file and
     * ThreadPoolExecutor for details.
     */
    public static final String GBL_ATT_THREADS_CORE_SIZE = "radiusThreadPoolCoreSize";

    /**
     * Name of the global radius service attribute whose value indicates the max pool size for the executor thread
     * pool that processes incoming RADIUS requests. See the service descriptor amRadiusServer.xml file and
     * ThreadPoolExecutor for details.
     */
     ...
     * See the service descriptor amRadiusServer.xml file.
     */
     ...
     * source IP address that does not match any client then the packet is dropped silently according to spec.
     * This value matches the corresponding field name declared in the amRadiusServer.xml file.
     */
     ...
     * packets for the client should be dumped to log with all content visible save for the USER_PASSWORD field
     * which is obfiscated with asterisks in place of characters.
     */
    ...
    /**
     * In a configured radius client this is the name of a list of configuration properties specific to
     * the handler class.
     */
     ...
     */
    public static final String[] STRING_ARY = new String[0];
    ...
    /**
     * The time period in seconds allowed for the RADIUS request handling pool to finish process current requests
     * before another warning message will be issued to log indicating that the pool is taking longer than allowed.
     */
